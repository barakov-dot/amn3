...
- Статус: research candidate после [PRVTPRO config delivery integrity](../research/upstreams/prvtpro-amnezia-web-panel-config-delivery-integrity.md); AMN2 bot delivery UX/localization slice выполнен в commit `908cafc`, а follow-up device sequence/external import visibility выполнен в commit `59bc266`; details in [Phase 4 bot config delivery localization](../research/amn2/phase-4-bot-config-delivery-localization-2026-06-11.md) and [Phase 4 device sequence and external import visibility](../research/amn2/phase-4-device-sequence-external-import-2026-06-11.md). Следующий safe local-only шаг: [Amnezia VPN / DefaultVPN upstream refresh](../research/upstreams/amnezia-vpn-client-defaultvpn-refresh-2026-06-11.md) -> `P4-AMNEZIA-REFRESH-002` client import compatibility matrix для `.conf`, `vpn://`, QR, future native `.vpn`/Amnezia JSON behavior and current client/platform availability constraints.
