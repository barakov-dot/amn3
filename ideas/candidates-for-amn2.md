...
- Статус: research candidate после [PRVTPRO config delivery integrity](../research/upstreams/prvtpro-amnezia-web-panel-config-delivery-integrity.md); AMN2 bot delivery UX/localization slice выполнен в commit `908cafc`, details in [Phase 4 bot config delivery localization](../research/amn2/phase-4-bot-config-delivery-localization-2026-06-11.md). Следующий safe local-only шаг: [Amnezia VPN / DefaultVPN upstream refresh](../research/upstreams/amnezia-vpn-client-defaultvpn-refresh-2026-06-11.md) -> `P4-AMNEZIA-REFRESH-002` client import compatibility matrix для `.conf`, `vpn://`, QR and future native `.vpn`/Amnezia JSON behavior.
