...
| [Panel #174](https://github.com/PRVTPRO/Amnezia-Web-Panel/pull/174), `cb0a5db3b568befe96792f4278baa493129011f5`: блокирующий SSH и backoff | уже учтено в плане | [Source review 20.09](../research/amn2/phase16-ssh-event-loop-applicability-2026-09-20.md): блокирующий SSH найден в async web health и условном bot revoke пути. Локальный web health fix 2069e41 реализован и pushed в AMN2: 33 synthetic PASS, review без замечаний. [Bot design согласован; implementation plan ожидает review](superpowers/plans/2026-09-20-amn2-bot-workflow-worker-plan.ru.md). Retry policy отдельно; не развёрнуто |
