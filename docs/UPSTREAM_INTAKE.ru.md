...
| DefaultVPN 2.0.2, версия сообщена оператором | недостаточно данных | [Уточнение](../research/amn2/phase16-amnezia-client-5.0.3.0-release-review-2026-09-21.md#defaultvpn-202-operator-report): версия известна со слов оператора; exact build/ОС/канал/source неизвестны. Предыдущий RU/US API snapshot 2.0.1 не опровергает сообщение; причину расхождения не выводить. Старые observations 2.0.1.1/cb7ea0c не переносить |
