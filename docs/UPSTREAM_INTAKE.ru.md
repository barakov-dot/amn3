...
| [Panel #174](https://github.com/PRVTPRO/Amnezia-Web-Panel/pull/174), `cb0a5db3b568befe96792f4278baa493129011f5`: блокирующий SSH и backoff | недостаточно данных | Сопоставить конкретные AMN2 handlers/runner с event loop и bounded retries. Нельзя отвергать всю идею только из-за отличий pooled SSH |
...
| [AWG Go](https://github.com/amnezia-vpn/amneziawg-go/compare/1b86b2a...b5928efb6ca19f0153958460c3d141f04abc5c2e): padding/cookies | недостаточно данных | Сопоставить pinned runtime SHA с fixes; существующая поддержка AWG3.1 не доказывает включение этих конкретных commits |
