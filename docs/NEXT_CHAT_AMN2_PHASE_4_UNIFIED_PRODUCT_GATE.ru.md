...
- source/package precheck: research/amn2/vps-rebuild-001-source-package-precheck-2026-06-10.md; source candidate `1508e3c4a100b76815b29f91757290f1266f813d`; focused local tests `30 passed, 1 warning`; package for `1508e3c` not built yet.
...
- активная критичная задача отдельного destructive stage: VPS-REBUILD-001, defer-awaiting-final-destructive-approval; source precheck completed; next required: build/verify `1508e3c` package locally and confirm provider snapshot;
