...
- historical recommended local-only follow-up `P5-I004` operator-only smoke checklist was completed in Phase 5; current next safe local-only recommendation is `P5-M003` AMN3 evidence discipline.
