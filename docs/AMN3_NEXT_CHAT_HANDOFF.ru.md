...
7. Писать только неинвазивные тесты, которые подтверждают, что write routes пока недоступны по умолчанию.
...
2. Заполнить `docs/AMN3_VPS_SMOKE_RESULT_TEMPLATE.ru.md`.
