...
latest proven VPS read-only smoke: c8a6363 pass, run_id 20260606T202040Z
...
c8a6363 package evidence: research/amn2/local-agent-runtime-summary-vps-package-2026-06-06.md
...
- Keep current VPS-smoked `/opt/amn2` runtime on `c8a6363`.
...
- [ ] `.amn2_source_overlay_commit` on VPS is `c8a6363` after applying the current kit.
...
- source overlay commit is not `c8a6363` after applying the current kit, or not an explicitly superseding smoke-passed commit;
