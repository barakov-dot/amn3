...
selected_next_track=generator-code / private self-config readiness final review
...
phase9_runtime_config_path_checklist_watch=runtime_path_discovery_required
...
next_step=AMN2_PHASE_9_PRIVATE_SELF_CONFIG_READINESS_FINAL_REVIEW_GATE
```
