...
Fresh v20 package/executor собраны дважды byte-equal и offline verified:
...
и `git diff --check` passed. Следующий gate — commit/push bindings, затем один
exact checksum-bound Spain install approval.
