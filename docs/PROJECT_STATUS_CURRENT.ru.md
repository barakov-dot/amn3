...
windows_filename_basename_inventory_found_generator_code_repo=false
...
windows_filename_basename_candidate_current_filename=amneziya-device-{device_id}.conf
...
next_step=AMN2_PHASE_9_WINDOWS_FILENAME_BASENAME_IMPLEMENTATION_READINESS_GATE
```
