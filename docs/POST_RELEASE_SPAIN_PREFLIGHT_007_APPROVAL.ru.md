...
Этот approval использован ровно один раз. Outcome
`spain-fresh-20260720-007` завершился fail-closed на strict envelope rejection;
он не даёт authority на retry или любой другой SSH action.
...
Запуск уже выполнен. Повторять literal approval нельзя. Новый outcome требует
новых runner checksums, нового diagnostic contract и отдельной exact approval.
