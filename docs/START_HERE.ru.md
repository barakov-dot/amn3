...
Обновлено: 2026-09-13. Это навигация, не второй execution plan и не подтверждение
...
3. [Актуальный план Phase 16](superpowers/plans/2026-08-24-amn2-phase16-awg3-family-3-1-spain-pilot.md):
   читать актуальный раздел; исторические приложения открывать только по конкретному
   вопросу. Переходы по прежним якорям сохранены, но не входят в очередь исполнения.
...
[Журнал изменений](../CHANGELOG.md) — что изменилось и чем проверено; обязательное
правило обновления перед commit/push находится в AGENTS.md.
...
закрывает интеграцию приложения и Phase 16. Локальный DNS-fix не меняет live-профили.
Deployed revision брать из разрешённого актуального evidence, не подменять git HEAD.
