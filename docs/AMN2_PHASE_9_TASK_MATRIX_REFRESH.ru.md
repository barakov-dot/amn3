...
phase10_next_product_step=START_PHASE10_CLIENT_DISPLAY_NAME_ROOT_CAUSE_ANALYSIS_SLICE
phase10_next_product_reason=resolve_amnezia_client_import_display_name_from_code_and_local_evidence
...
- Следующий Phase 10 product-step:
  `START_PHASE10_CLIENT_DISPLAY_NAME_ROOT_CAUSE_ANALYSIS_SLICE`.
