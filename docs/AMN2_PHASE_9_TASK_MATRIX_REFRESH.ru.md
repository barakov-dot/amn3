...
phase10_next_product_step=START_PHASE10_OPERATOR_SINGLE_DEVICE_CREATE_PATH_HARDENING_SLICE
phase10_next_product_reason=explicit_owner_supported_service_audit_and_full_partial_failure_rollback_required_before_reuse_then_android_device_acceptance
