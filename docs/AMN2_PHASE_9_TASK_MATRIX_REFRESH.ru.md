...
phase10_android_tv_single_peer_config_status=completed-private-operator-only
...
phase10_next_product_step=PRIVATE_ANDROID_TV_OPERATOR_IMPORT_REVIEW_OR_SELECT_NEXT_PHASE10_PRODUCT_SLICE
phase10_next_product_reason=android_tv_peer_and_private_config_ready_import_test_is_operator_device_step_no_secret_publication
