...
restore_001a_gate=attempt_1_fail_closed|sanitized_config_path_format_diagnosis_pending
...
next=DIAGNOSE_SAFE_CONFIG_PATH_SHAPE_THEN_TDD_FIX_TEST_SECURITY_DOCS_COMMIT_PUSH_AND_RETRY_APPROVED_RESTORE_001A
```
