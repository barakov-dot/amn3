# Phase 16 — проект критериев приёмки v1

Дата: 2026-09-07. Статус: `DRAFT_NOT_APPROVED_NOT_EXECUTED`.
Основание: операторское «продолжай» после локального DNS-исправления,
baseline `7f867be92a75f401d9b061e41bf6605b8f9e5d14`.
Область — локальное предложение; live, установка, изменение конфигов и push
не разрешаются. iPhone/две сети остаются отложенными по решению оператора.

Числа ниже — предлагаемые инженерные требования к операторскому пилоту для
обычного веба, видео и мессенджеров. Это не норматив, не гарантия скорости сервера
и не обещание качества 4K/игр. Согласовать их нужно ДО acceptance-прогона.
...
| Проверка | Критерий для согласования | Доказательство и граница |
| --- | --- | --- |
...
- No-VPN baseline характеризует ёмкость сети. Предлагаемый минимум пригодности
...
Это проект критериев, не готовый live-runner и не /APPROVE. До запуска нужно:

- согласовать профиль 20/5 Mbps и остальные предложенные пределы;
