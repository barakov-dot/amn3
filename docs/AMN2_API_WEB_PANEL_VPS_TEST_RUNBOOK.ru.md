...
Важно: команды ниже используют текущий package `c8a6363`; он package-ready, но еще не прошел VPS read-only smoke. Последний VPS-smoked runtime/source остается `32d01fd`, `run_id=20260606T185114Z`. Пакеты `1a193b9` и `568c611` остаются historical prior VPS-smoked runtime/source, а `294803e` остается historical API/web-panel evidence.
