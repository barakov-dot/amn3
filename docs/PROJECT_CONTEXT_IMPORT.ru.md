...
PRVTPRO AMN2 local-only order: P4-PRVTPRO-REFRESH-002 expiration-field contract tests completed in AMN2 commit b2eceeb111a0a27e41daf7b9ae7c79b5a0195e51; P4-PRVTPRO-REFRESH-001 read-only About/Version/Build status completed in AMN2 commit dc7966628e490da018f55fafe0fc559b44cc1dfa; next safe PRVTPRO-derived item is P4-PRVTPRO-REFRESH-004 API taxonomy/OpenAPI grouping as docs/policy support; P4-PRVTPRO-REFRESH-003 read-only server status/latency UX only after design boundary
