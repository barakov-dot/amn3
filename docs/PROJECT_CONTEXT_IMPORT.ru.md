...
PRVTPRO AMN2 local-only order: P4-PRVTPRO-REFRESH-002 expiration-field contract tests first; P4-PRVTPRO-REFRESH-001 read-only About/Version/Build status second; P4-PRVTPRO-REFRESH-003 read-only server status/latency UX only after design boundary; P4-PRVTPRO-REFRESH-004 API taxonomy/OpenAPI grouping as docs/policy support
