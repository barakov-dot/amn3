...
6. Latest AMN2 local/integration head is `ad6aa1b` after `P5-M006` Telegram import link copy affordance; CPython 3.12.x remains the supported local runtime, Python 3.14 remains a separate future upgrade gate.
