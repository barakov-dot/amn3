...
AMN3 source-overlay permission preservation: research/amn2/phase-5-source-overlay-permission-preservation-2026-06-12.md; `P5-C005` closed as local package tooling/test fix, `scripts/vps/amn2_apply_source_zip.sh` now preserves target-root metadata, uses service-readable source permissions and has regression coverage; next recommendation is `P5-C004` secret handoff protocol
