...
P4-NG closed: NG-C001 named gate charter, NG-C002 safety boundary restatement, NG-C003 secrets policy, NG-C004 go/no-go format, NG-S003 reusable named-gate evidence template
P4-NG template: research/amn2/phase-4-ng-named-gate-evidence-template-2026-06-10.md
P4-NG next recommended docs-only task: NG-C005 keep write API live work blocked
