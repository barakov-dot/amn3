...
AMN3 operator docs cleanup: research/amn2/phase-5-operator-docs-cleanup-2026-06-12.md; `P5-N001` closed as docs-only cleanup that removed stale active references to already closed gate slices and refreshed the Phase 5 handoff/status/context/backlog trail; next recommendation is `P5-N003` after the next Amnezia upstream watcher run
