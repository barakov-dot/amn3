...
AMN3 live rollout: research/amn2/phase-5-live-rollout-de25576-2026-06-12.md; `P5-C003` closed for disposable test VPS, source overlay and read-only API smoke passed, web/bot active after permission repair, public `3040/80/443` absent, next recommendation is `P5-C005` local package tooling/runbook permission-preservation fix
