...
6. Latest AMN2 local/integration head is `17454e9` after `P5-N002` web-panel service-mode/external-only copy polish; CPython 3.12.x remains the supported local runtime, Python 3.14 remains a separate future upgrade gate.
