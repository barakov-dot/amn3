...
6. Latest AMN2 local/integration head is `578d91e` after `P5-I003` runtime/toolchain standardization; CPython 3.12.x is the supported local runtime, Python 3.14 remains a separate future upgrade gate.
