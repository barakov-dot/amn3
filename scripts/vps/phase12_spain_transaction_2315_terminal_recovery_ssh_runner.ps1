...
$expectedNonce = "2315caba94df97a4a34c665fb58401f0bd56e1721a7cea59af20c38f23b8046c"
$expectedTransactionSha = "e4507cd1483d9b6aeb89da825ffed9b18bba8239ce7aacbba97e1b9e36aedc74"
$expectedCapsuleSha = "e9e2b849a8afa296cad980396f5bec81dc5fe15913a99d5df738fa15cb4cef12"
$expectedDockerTreeSha = "067776d5cff3b28c7404ff9f9a6494ea2bd7c7fb473b410dcc62f37282a419e4"
...
if ($remoteHash.ExitCode -ne 0 -or $remoteText -notmatch "(?im)^$($expectedExecutorSha.ToLowerInvariant())  /root/amn2-spain-phase12-executor\.pyz$") { throw "Remote transaction 2315 terminal recovery executor checksum mismatch." }
...
if ($result.ExitCode -ne 0) {
    ...
    throw "Transaction 2315 terminal recovery failed; current transaction remains fail-closed."
}
