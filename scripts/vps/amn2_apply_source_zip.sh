...
AMN2_SOURCE_ZIP="${AMN2_SOURCE_ZIP:-/root/amn2-read-only-api-route-shell-2010d60-source.zip}"
AMN2_EXPECTED_SOURCE_SHA="${AMN2_EXPECTED_SOURCE_SHA:-783315D4E296B0FD062379977E325A28380C7911337594EEAD4B49680FBFAF33}"
AMN2_EXPECTED_SOURCE_COMMIT="${AMN2_EXPECTED_SOURCE_COMMIT:-2010d60}"
...
for module in ("fastapi", "uvicorn", "app.cli", "app.api.app", "app.services.api_smoke"):
