...
$expectedRunId = "spain-resource-confirmation-20260722-019"
...
function Write-SanitizedOutcomeReceipt(
    ...
    $AllowedConflictCodes = @(
        ...
        ,"PLATFORM_OS_INCOMPATIBLE", "PLATFORM_KERNEL_INCOMPATIBLE", "PLATFORM_PYTHON_INCOMPATIBLE",
        "PLATFORM_GLIBC_INCOMPATIBLE", "CAPACITY_MEMORY_INSUFFICIENT", "CAPACITY_DISK_INSUFFICIENT",
        "CAPACITY_INODES_INSUFFICIENT", "FIREWALL_NAMESPACE_PRESENT"
    )
