...
CORE_SIZE = 23283
MANIFEST_SIZE = 23102
CORE_SHA256 = "87e82ae875250ef0b02f62776aaa195fb1bc00178b1d04029b55c617dac0b938"
MANIFEST_SHA256 = "dc8462f415890d1d8bb975f915531a314fe8bfc85a5549e1f85b58d81c3228dc"
PAYLOAD_SIZE = 46409
PAYLOAD_SHA256 = "1e817e1a05b74733577341b103453820d5a54438e500efd596ce46718425ab3b"
...
if len(p)!=46409 or hashlib.sha256(p).hexdigest()!='1e817e1a05b74733577341b103453820d5a54438e500efd596ce46718425ab3b' or p[:8]!=b'P16IRB01': stop('payload_binding')
c=int(p[8:16]);m=int(p[16:24])
if (c,m)!=(23283,23102): stop('payload_binding')
core=p[24:24+c]; manifest=p[24+c:]
if hashlib.sha256(core).hexdigest()!='87e82ae875250ef0b02f62776aaa195fb1bc00178b1d04029b55c617dac0b938' or hashlib.sha256(manifest).hexdigest()!='dc8462f415890d1d8bb975f915531a314fe8bfc85a5549e1f85b58d81c3228dc': stop('payload_binding')
