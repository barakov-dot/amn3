...
APPROVAL = "PHASE16_ACTUAL_INTEGRATION_READBACK_20260922_008"
GATE_MANIFEST_RELATIVE = Path(
    "research/amn2/phase16-bot-integration-readback-gate-008-manifest-2026-09-22.json"
)
EVIDENCE_DIRECTORY = Path(
    "C:/Users/SooL/Documents/VPS-OPS-LAB/worktrees/"
    "phase16-bot-integration-readback-runner-20260922/execution-008"
)
...
def remote_script(root=ROOT):
    ...
    compile(data, "<bound-phase16-integration-readback-008>", "exec")
    return data
...
def validate_gate_manifest(value, root=ROOT):
    ...
    blobs = {
        "local_runner": canonical(root / "scripts/phase16_bot_integration_readback_gate_008.py",
                                  compile_python=True),
    ...
    expected = {
        ...
        "amn3_base": "ec2f8926e773e2c9233c9acc65df2fbee151fb7e",
        ...
        "command_contract": {
            "entrypoint": "scripts/phase16_bot_integration_readback_gate_008.py",
...
def frame_request(script, payload):
    ...
    bootstrap = (
        ...
        "exec(compile(b,'<bound-phase16-integration-readback-008>','exec'),{'__name__':'__main__'})"
    )
...
def execute_once(evidence_dir, *, approval, approved_remote_sha,
    ...
    try:
        ...
        try:
            receipt = base.validate_receipt(parsed, returncode)
        except core.Stop:
