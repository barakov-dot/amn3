...
current_vps_source_overlay=34b3b43
latest_product_head=1c7fb78_not_packaged_not_uploaded
device8_assignment_reconciliation=pending_separate_live_db_gate
next_step=START_PHASE10_1C7FB78_VPS_PACKAGE_PREP_SLICE
```
