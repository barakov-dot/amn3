...
2. `NG-C001`, `NG-C002`, `NG-C003`, `NG-C004`, `NG-S003`, `NG-C005`, `WAPI-V001`, `WAPI-V002`, `WAPI-V003`, `P4-PRVTPRO-REFRESH-002`, `P4-PRVTPRO-REFRESH-001` and `P4-PRVTPRO-REFRESH-004` are closed.
3. Next recommended docs-only task is `WAPI-V004` idempotency, locking and partial-failure model with `live_write_authorized: no`.
