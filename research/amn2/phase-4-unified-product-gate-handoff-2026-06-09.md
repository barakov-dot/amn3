...
6. Destructive fresh VPS rebuild has separate gate `VPS-REBUILD-001`, currently opened as `defer`; no destructive action is authorized until required decisions and exact final phrase are present.
