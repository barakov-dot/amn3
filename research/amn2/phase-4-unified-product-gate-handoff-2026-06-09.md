...
6. Destructive fresh VPS rebuild has separate gate `VPS-REBUILD-001`, currently opened as `defer`; novice-safe mode selects provider snapshot first and regenerate/operator-local secret handling. Source precheck selected AMN2 `1508e3c4a100b76815b29f91757290f1266f813d`, but package build/hygiene is still pending. No destructive action is authorized until package checksum/hygiene/test-extract, provider snapshot confirmation, stop-criteria review and exact final phrase are present.
