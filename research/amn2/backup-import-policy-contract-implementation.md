...
- если VPS все еще не готов - не открывать новый local-only implementation slice; generic route-policy/audit/rate-limit guards уже закрыты, допустима только синхронизация roadmap/evidence.
