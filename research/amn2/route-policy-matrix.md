...
- Backup/import policy contract выполнен в `amn2/codex/backup-import-policy-contract`, head `afb2702` with foundation commit `d2c160b`; web/API backup routes, full backup download, restore apply и import apply не добавлять без route gate, confirmation, audit и backup-before-write.
