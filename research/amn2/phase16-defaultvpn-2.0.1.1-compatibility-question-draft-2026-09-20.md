...
Статус: DRAFT_NOT_SENT. Подготовлено 2026-09-20 по итогам локальной проверки.
...
Никакие сообщения, issues или вложения пока не отправлены.
...
- Проверка обсуждений ограничена этим официальным репозиторием; отсутствие дубля
  ...
  не писать в нерелевантные PR или Windows #3043. Отправка письма не выполнена.
