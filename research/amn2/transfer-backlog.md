...
Neighboring AMN2 status follow-up 2026-06-07: `amn2/codex-vps-test-prep` advanced to `f7f6131 Update integration status for c92 manual prelaunch`. This is a read-only status-visibility update to `/api/integration/status` and web `/integration-status`; the current proven VPS source overlay remains `c92bd1a` until a newer update+smoke kit is applied and smoked. Evidence: `research/amn2/manual-prelaunch-integration-status-2026-06-07.md`.

Status-alignment package 2026-06-07: AMN3 update+smoke kit for `f7f6131` is prepared. Package: `dist/amn2-vps-update-and-smoke-kit-f7f6131.zip`, sha256 `19BF96A7E1057C042B89630BF80ADC7A9F5A09A62436E33A8555D7E2991AF282`; source sha256 `720B6C9FE3CADDBC65C19BDEC5B0C811D00C94EB0D095D6311DCD90DD77BE4E1`; evidence `research/amn2/f7f6131-status-alignment-vps-package-2026-06-07.md`. Status is `package-prepared`; VPS source-overlay smoke is pending.
