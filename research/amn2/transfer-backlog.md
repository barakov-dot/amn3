...
2. Выполнить real VPS loopback API smoke через `scripts/vps/amn2_api_loopback_smoke.sh` по инструкции `docs/AMN2_VPS_OPERATOR_API_SMOKE.ru.md`; raw token/header/hash/config/keys/PSK не фиксировать в чатах.
