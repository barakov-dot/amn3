...
| VPS install/update package | `published-updated-stable-5f12736` | AMN3 package for `amn2` | `dist/amn2-vps-install-5f12736.zip`, sha256 `5CD7EFEAC92BF9ED6A93D6DC4114536298085A829392659C28096FEFD9E2AF19`; `dist/amn2-vps-update-and-smoke-kit-5f12736.zip`, sha256 `5AAD3373DF587338166F421AA269267A170B028E49F1A606937A89076C239935`; historical `d0939d8` package remains available | Использовать `install` для чистой установки, `update+smoke` для существующего `/opt/amn2` с сохранением `.env`/`data`/`venv`/`servers.yml` |
