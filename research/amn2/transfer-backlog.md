...
Manual prelaunch 2026-06-07: validation VPS `mirror` passed backup create/verify, repeat loopback API smoke `run_id=20260607T194229Z`, manual web `/login` check on `127.0.0.1:3030`, and bot network check. Permanent `systemd`/reverse proxy deployment is deferred because the working server will be different. Evidence: `research/amn2/c92bd1a-manual-prelaunch-evidence-2026-06-07.md`.
...
current source-overlay package sha256: EC48DBA7C91F189512AB77EB5490432C85DA79F987068A98C1CC7F3082387F12
current source-overlay source sha256: 272CC013A416937AAA2256A1643B2C77F707874D28FDCB2EA16534E349DD4FC2
...
manual prelaunch validation: passed; systemd/reverse proxy deferred-working-server
...
current VPS-smoked package/source: c92bd1a, run_id 20260607T182131Z, checked_routes=6
...
source-overlay package sha256: EC48DBA7C91F189512AB77EB5490432C85DA79F987068A98C1CC7F3082387F12
source-overlay source sha256: 272CC013A416937AAA2256A1643B2C77F707874D28FDCB2EA16534E349DD4FC2
...
| VPS install/update package | `read-only-vps-smoke-pass-c92bd1a` | AMN3 package for `amn2` | source-overlay update+smoke kit `dist/amn2-vps-update-and-smoke-kit-c92bd1a.zip`, sha256 `EC48DBA7C91F189512AB77EB5490432C85DA79F987068A98C1CC7F3082387F12`; source `dist/amn2-codex-vps-test-prep-c92bd1a-source.zip`, sha256 `272CC013A416937AAA2256A1643B2C77F707874D28FDCB2EA16534E349DD4FC2`; package evidence `research/amn2/web-admin-loopback-systemd-vps-package-2026-06-07.md`; VPS smoke evidence `research/amn2/web-admin-loopback-systemd-vps-smoke-evidence-2026-06-07.md`; prior VPS-smoked kit `dist/amn2-vps-update-and-smoke-kit-42ffa65.zip`, `run_id=20260607T165625Z` | `c92bd1a` is the current VPS-smoked runtime/source baseline. Keep `VPS_APPLY_ENABLED=false`; live write remains a separate gate |
| Controlled prod readiness | `controlled-prod-ready-manual-prelaunch-pass` | AMN3 operator gate | `docs/AMN2_CONTROLLED_PROD_READINESS_RUNBOOK.ru.md`; handoff `docs/NEXT_CHAT_AMN2_CONTROLLED_PROD_DECISION.ru.md`; readiness evidence `research/amn2/controlled-prod-readiness-2026-06-06.md`; reverse proxy confirmation `research/amn2/controlled-prod-reverse-proxy-confirmation-2026-06-07.md`; final decision `research/amn2/controlled-prod-ready-2026-06-07.md`; current VPS-smoked package/source `c92bd1a`, read-only VPS smoke `run_id=20260607T182131Z`, `checked_routes=6`; manual prelaunch evidence `research/amn2/c92bd1a-manual-prelaunch-evidence-2026-06-07.md`; web/admin systemd template confirmed loopback-only | Validation VPS manual prelaunch passed; repeat safe gate and enable systemd/reverse proxy on future working server. This is not public API `3040`, not broad write/API/config/backup/agent surfaces |
