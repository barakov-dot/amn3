...
| Backup/import policy contract | `implemented-pushed-local-gate-complete` | `amn2` | branch `codex/backup-import-policy-contract`, commit `d2c160b`; evidence `research/amn2/backup-import-policy-contract-implementation.md`; RED `1 import error as expected`; focused `63 passed`; full suite `583 passed` | Использовать как no-route backup/import policy baseline; web/API full backup, restore apply и import apply остаются отдельными gates |
...
6. Backup/import policy contract выполнен и запушен в `amn2/codex/backup-import-policy-contract`, commit `d2c160b`; использовать как no-route policy/preview baseline, без web/API full backup, restore apply или import apply.
