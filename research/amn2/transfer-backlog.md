...
8. Public/self-service config delivery policy подготовлен в `research/amn2/public-self-service-config-delivery-policy.md`; пока VPS не готов, следующий local-only перенос - только no-route policy registry/share-token contract, без public download route.
