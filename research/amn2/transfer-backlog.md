...
Update 2026-06-07: `amn2/codex-vps-test-prep` current git head is `42ffa65 Record git checkout smoke status`. The current app-code read-only smoke slice is `62ff184 Update controlled prod status visibility`, which passed real VPS git-checkout smoke on `/opt/amn2-git` with `checked_routes=6`; AMN3 package `42ffa65` then passed safe source-overlay update/read-only smoke on `/opt/amn2`. Current VPS source overlay is now `42ffa65`, `api_smoke_run_id=20260607T165625Z`. `c8a6363` is historical prior VPS-smoked runtime/source, `run_id=20260606T202040Z`; `32d01fd` and `1a193b9` are older historical baselines.

Follow-up 2026-06-07: `amn2/codex-vps-test-prep` advanced to `c92bd1a Bind web admin systemd to loopback`. This is a controlled production launch safety slice: web/admin systemd template uses `127.0.0.1:3030` by default for the approved HTTPS reverse proxy mode. AMN3 package is ready but not VPS-smoked yet: `dist/amn2-vps-update-and-smoke-kit-c92bd1a.zip`, sha256 `EC48DBA7C91F189512AB77EB5490432C85DA79F987068A98C1CC7F3082387F12`; evidence `research/amn2/web-admin-loopback-systemd-vps-package-2026-06-07.md`.

`42ffa65` VPS smoke 2026-06-07: source update preserved `.env`, `data/`, `venv/` and `servers.yml`; read-only API smoke passed with `checked_routes=6`, auth 401/403/401, listener `127.0.0.1:3040` loopback-only, audit safe, server DB sync passed. Evidence: `research/amn2/controlled-prod-status-visibility-vps-smoke-evidence-2026-06-07.md`.
...
current source-overlay package sha256: 5B43B467E014E87FEC1E49E8D9A8B7A2FBF841541BE88FDC6768097806240E39
current source-overlay source sha256: 8A5B83D9AB95BE4230AAC221CE0321A37EF37E4E4B6EAB5EDECAE3C98A944829
current source-overlay package status: read-only-vps-smoke-pass
local verification: focused status tests 8 passed; package SHA/source SHA/no-BOM/no-CRLF/no-forbidden-source-entry/test-extract checks passed
package evidence: research/amn2/controlled-prod-status-visibility-vps-package-2026-06-07.md
VPS result for 42ffa65: read-only-vps-smoke-pass, run_id 20260607T165625Z
VPS smoke evidence: research/amn2/controlled-prod-status-visibility-vps-smoke-evidence-2026-06-07.md
previous VPS-smoked runtime/source: c8a6363, run_id 20260606T202040Z, evidence research/amn2/local-agent-runtime-summary-vps-smoke-evidence-2026-06-06.md
...
current VPS-smoked package/source: 42ffa65, run_id 20260607T165625Z
...
source-overlay source sha256: 8A5B83D9AB95BE4230AAC221CE0321A37EF37E4E4B6EAB5EDECAE3C98A944829
source-overlay package status: read-only-vps-smoke-pass
prepared web-admin loopback package: dist/amn2-vps-update-and-smoke-kit-c92bd1a.zip
prepared web-admin loopback package status: package-ready-not-vps-smoked
...
| VPS install/update package | `read-only-vps-smoke-pass-42ffa65` | AMN3 package for `amn2` | source-overlay update+smoke kit `dist/amn2-vps-update-and-smoke-kit-42ffa65.zip`, sha256 `5B43B467E014E87FEC1E49E8D9A8B7A2FBF841541BE88FDC6768097806240E39`; source `dist/amn2-codex-vps-test-prep-42ffa65-source.zip`, sha256 `8A5B83D9AB95BE4230AAC221CE0321A37EF37E4E4B6EAB5EDECAE3C98A944829`; package evidence `research/amn2/controlled-prod-status-visibility-vps-package-2026-06-07.md`; VPS smoke evidence `research/amn2/controlled-prod-status-visibility-vps-smoke-evidence-2026-06-07.md`; prior VPS-smoked kit `dist/amn2-vps-update-and-smoke-kit-c8a6363.zip`, `run_id=20260606T202040Z` | `42ffa65` is the current VPS-smoked runtime/source baseline. Keep `VPS_APPLY_ENABLED=false`; live write remains a separate gate |
| Controlled prod readiness | `controlled-prod-ready` | AMN3 operator gate | `docs/AMN2_CONTROLLED_PROD_READINESS_RUNBOOK.ru.md`; handoff `docs/NEXT_CHAT_AMN2_CONTROLLED_PROD_DECISION.ru.md`; readiness evidence `research/amn2/controlled-prod-readiness-2026-06-06.md`; reverse proxy confirmation `research/amn2/controlled-prod-reverse-proxy-confirmation-2026-06-07.md`; final decision `research/amn2/controlled-prod-ready-2026-06-07.md`; current VPS-smoked package/source `42ffa65`, read-only VPS smoke `run_id=20260607T165625Z`; current AMN2 git head `c92bd1a` package-ready for loopback web-admin systemd | Continue with `c92bd1a` source-overlay smoke, then controlled production launch checklist. This is not public API `3040`, not broad write/API/config/backup/agent surfaces |
| Controlled prod status visibility | `source-overlay-vps-smoke-pass` | `amn2` stable branch + AMN3 evidence | VPS-smoked AMN2 head `42ffa65`; app-code smoke slice `62ff184`; git-checkout evidence `research/amn2/controlled-prod-status-visibility-git-checkout-smoke-2026-06-07.md`; source-overlay evidence `research/amn2/controlled-prod-status-visibility-vps-smoke-evidence-2026-06-07.md`; AMN2 source docs `docs/API_VPS_SMOKE_EVIDENCE.ru.md` and `docs/AMN2_VPS_SMOKE_62FF184_RUNBOOK.ru.md` | Promotion completed for read-only status visibility. Current git head advanced to `c92bd1a` for web-admin loopback template; no write/config/backup/agent mutation unlock |
...
| Web-admin loopback systemd package | `package-ready-not-vps-smoked` | AMN3 package for `amn2` | AMN2 head `c92bd1a`; `dist/amn2-vps-update-and-smoke-kit-c92bd1a.zip`, sha256 `EC48DBA7C91F189512AB77EB5490432C85DA79F987068A98C1CC7F3082387F12`; source sha256 `272CC013A416937AAA2256A1643B2C77F707874D28FDCB2EA16534E349DD4FC2`; evidence `research/amn2/web-admin-loopback-systemd-vps-package-2026-06-07.md` | Promote through source-overlay update/smoke before copying/enabling web systemd unit for controlled production launch. Keep backend on `127.0.0.1:3030`, API `3040` loopback-only |
