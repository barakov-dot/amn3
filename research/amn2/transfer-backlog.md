...
Update 2026-06-06: `amn2/codex-vps-test-prep` current head is `c8a6363 Add Local Agent runtime summary mapper`. Current AMN3 update+smoke package for the git head is `c8a6363` and is package-ready but not VPS-smoked. The last VPS-smoked package/source is `32d01fd`, which passed real VPS read-only smoke on 2026-06-06, `run_id=20260606T185114Z`; `1a193b9` is now historical prior VPS-smoked runtime/source.

`c8a6363` VPS smoke preflight 2026-06-06: local package SHA/source SHA and source hygiene checks passed, but real VPS update/smoke was not run from the desktop environment because the available local server config uses password auth and no safe non-interactive SSH path was present. Evidence: `research/amn2/c8a6363-vps-smoke-preflight-2026-06-06.md`. Status remains `package-ready-not-vps-smoked`.
...
current git-head package: dist/amn2-vps-update-and-smoke-kit-c8a6363.zip
current git-head package sha256: 027ECC1BAD7321FCCD61A4CCCA3AC9F06AAA9AC6A3D7115B4813253D19C2CFBF
current git-head source sha256: E1E198979D988B3A5AA038CF732B8DCDBE854C48A6D381FADBA05BFDEE0251C6
current git-head package status: package-ready-not-vps-smoked; local preflight passed, real VPS smoke not run
...
current AMN2 git head: c8a6363 Add Local Agent runtime summary mapper
current VPS-smoked package/source: 32d01fd, run_id 20260606T185114Z
...
| VPS install/update package | `package-ready-c8a6363-local-preflight-pass-not-vps-smoked` | AMN3 package for `amn2` | current git-head update+smoke kit `dist/amn2-vps-update-and-smoke-kit-c8a6363.zip`, sha256 `027ECC1BAD7321FCCD61A4CCCA3AC9F06AAA9AC6A3D7115B4813253D19C2CFBF`; source `dist/amn2-codex-vps-test-prep-c8a6363-source.zip`, sha256 `E1E198979D988B3A5AA038CF732B8DCDBE854C48A6D381FADBA05BFDEE0251C6`; package evidence `research/amn2/local-agent-runtime-summary-vps-package-2026-06-06.md`; preflight evidence `research/amn2/c8a6363-vps-smoke-preflight-2026-06-06.md`; last VPS-smoked kit `dist/amn2-vps-update-and-smoke-kit-32d01fd.zip`, `run_id=20260606T185114Z` | Use `c8a6363` for the next real operator read-only update/smoke if continuing current git head; until then `32d01fd` remains the current VPS-smoked runtime/source baseline. Smoke must keep `VPS_APPLY_ENABLED=false`; live write remains a separate gate |
| Controlled prod readiness | `readiness-prefill-recorded-operator-confirmations-pending` | AMN3 operator gate | `docs/AMN2_CONTROLLED_PROD_READINESS_RUNBOOK.ru.md`; next chat `docs/NEXT_CHAT_AMN2_CONTROLLED_PROD_DECISION.ru.md`; evidence `research/amn2/controlled-prod-readiness-2026-06-06.md`; current git head `c8a6363`, current VPS-smoked package/source `32d01fd`, read-only VPS smoke `run_id=20260606T185114Z` | Оператору подтвердить remaining readiness fields и зафиксировать `controlled-prod-ready`, `needs-fix` или `defer-prod`; это не public prod и не разрешение на broad write/API/config/backup/agent surfaces |
...
| Local Agent runtime metadata alignment | `merged-stable-local-only` | `amn2` stable branch + AMN3 evidence | `amn2/codex-vps-test-prep` at `c8a6363`; branch `amn2/codex/local-agent-runtime-summary`; `research/amn2/local-agent-runtime-metadata-alignment.md`; `docs/superpowers/specs/2026-06-06-local-agent-runtime-summary-design.md`; `docs/superpowers/plans/2026-06-06-local-agent-runtime-summary.md`; `research/amn2/local-agent-runtime-summary-implementation-2026-06-06.md` | Mapper-only controller-safe runtime summary merged into stable; no clients/configs, no API route, no VPS command; VPS-smoked package/source remains `32d01fd` until separate update/read-only smoke |
