...
| Controlled prod readiness | `readiness-prefill-recorded-operator-confirmations-pending` | AMN3 operator gate | `docs/AMN2_CONTROLLED_PROD_READINESS_RUNBOOK.ru.md`; next chat `docs/NEXT_CHAT_AMN2_CONTROLLED_PROD_DECISION.ru.md`; evidence `research/amn2/controlled-prod-readiness-2026-06-06.md`; current branch head `32d01fd`, read-only VPS smoke `run_id=20260606T185114Z` | Оператору подтвердить remaining readiness fields и зафиксировать `controlled-prod-ready`, `needs-fix` или `defer-prod`; это не public prod и не разрешение на broad write/API/config/backup/agent surfaces |
...
| Local Agent runtime metadata alignment | `feature-branch-pushed-local-only` | `amn2` branch + AMN3 evidence | `amn2/codex/local-agent-runtime-summary` at `c8a6363`; `research/amn2/local-agent-runtime-metadata-alignment.md`; `docs/superpowers/specs/2026-06-06-local-agent-runtime-summary-design.md`; `docs/superpowers/plans/2026-06-06-local-agent-runtime-summary.md`; `research/amn2/local-agent-runtime-summary-implementation-2026-06-06.md` | Mapper-only controller-safe runtime summary branch pushed; no clients/configs, no API route, no VPS command; next step is review/merge decision |
