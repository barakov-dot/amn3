...
VPS result for c92bd1a: read-only-vps-smoke-pass, run_id 20260607T182131Z
...
current VPS-smoked package/source: c92bd1a, run_id 20260607T182131Z
...
| Web-admin loopback systemd package | `read-only-vps-smoke-pass` | AMN3 package for `amn2` | AMN2 head `c92bd1a`; `dist/amn2-vps-update-and-smoke-kit-c92bd1a.zip`, sha256 `EC48DBA7C91F189512AB77EB5490432C85DA79F987068A98C1CC7F3082387F12`; source sha256 `272CC013A416937AAA2256A1643B2C77F707874D28FDCB2EA16534E349DD4FC2`; package evidence `research/amn2/web-admin-loopback-systemd-vps-package-2026-06-07.md`; smoke evidence `research/amn2/web-admin-loopback-systemd-vps-smoke-evidence-2026-06-07.md` | Source-overlay update/smoke passed; next step is copying/enabling web/bot systemd through controlled production launch checklist. Keep backend on `127.0.0.1:3030`, API `3040` loopback-only |
