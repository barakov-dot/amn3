...
| Controlled prod readiness | `readiness-prefill-recorded-operator-confirmations-pending` | AMN3 operator gate | `docs/AMN2_CONTROLLED_PROD_READINESS_RUNBOOK.ru.md`; evidence `research/amn2/controlled-prod-readiness-2026-06-06.md`; current branch head `32d01fd`, read-only VPS smoke `run_id=20260606T185114Z` | Оператору подтвердить remaining readiness fields и зафиксировать `controlled-prod-ready`, `needs-fix` или `defer-prod`; это не public prod и не разрешение на broad write/API/config/backup/agent surfaces |
