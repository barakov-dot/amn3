...
Update 2026-06-07: `amn2/codex-vps-test-prep` current git head is `42ffa65 Record git checkout smoke status`. The current app-code read-only smoke slice is `62ff184 Update controlled prod status visibility`, which passed real VPS git-checkout smoke on `/opt/amn2-git` with `checked_routes=6`; source-overlay promotion to `/opt/amn2` is still pending. Current VPS source overlay remains `c8a6363 Add Local Agent runtime summary mapper`, which passed real VPS read-only smoke on 2026-06-06, `run_id=20260606T202040Z`. `32d01fd` is historical prior VPS-smoked runtime/source, `run_id=20260606T185114Z`; `1a193b9` is the previous historical runtime/source before that.
...
current source-overlay package: dist/amn2-vps-update-and-smoke-kit-c8a6363.zip
current source-overlay package sha256: 027ECC1BAD7321FCCD61A4CCCA3AC9F06AAA9AC6A3D7115B4813253D19C2CFBF
current source-overlay source sha256: E1E198979D988B3A5AA038CF732B8DCDBE854C48A6D381FADBA05BFDEE0251C6
...
current VPS-smoked package/source: c8a6363, run_id 20260606T202040Z
...
prepared source-overlay source sha256: 8A5B83D9AB95BE4230AAC221CE0321A37EF37E4E4B6EAB5EDECAE3C98A944829
...
| VPS install/update package | `read-only-vps-smoke-pass-c8a6363` | AMN3 package for `amn2` | source-overlay update+smoke kit `dist/amn2-vps-update-and-smoke-kit-c8a6363.zip`, sha256 `027ECC1BAD7321FCCD61A4CCCA3AC9F06AAA9AC6A3D7115B4813253D19C2CFBF`; source `dist/amn2-codex-vps-test-prep-c8a6363-source.zip`, sha256 `E1E198979D988B3A5AA038CF732B8DCDBE854C48A6D381FADBA05BFDEE0251C6`; package evidence `research/amn2/local-agent-runtime-summary-vps-package-2026-06-06.md`; VPS smoke evidence `research/amn2/local-agent-runtime-summary-vps-smoke-evidence-2026-06-06.md`; prior VPS-smoked kit `dist/amn2-vps-update-and-smoke-kit-32d01fd.zip`, `run_id=20260606T185114Z` | `c8a6363` is the current VPS-smoked runtime/source baseline. Keep `VPS_APPLY_ENABLED=false`; live write remains a separate gate |
| Controlled prod readiness | `controlled-prod-ready` | AMN3 operator gate | `docs/AMN2_CONTROLLED_PROD_READINESS_RUNBOOK.ru.md`; handoff `docs/NEXT_CHAT_AMN2_CONTROLLED_PROD_DECISION.ru.md`; readiness evidence `research/amn2/controlled-prod-readiness-2026-06-06.md`; reverse proxy confirmation `research/amn2/controlled-prod-reverse-proxy-confirmation-2026-06-07.md`; final decision `research/amn2/controlled-prod-ready-2026-06-07.md`; current VPS-smoked package/source `c8a6363`, read-only VPS smoke `run_id=20260606T202040Z`; current AMN2 git head later advanced to `42ffa65` for read-only status evidence | Continue with read-only next slice. This is not public API `3040`, not broad write/API/config/backup/agent surfaces |
| Controlled prod status visibility | `git-checkout-vps-smoke-pass-source-overlay-pending` | `amn2` stable branch + AMN3 evidence | current AMN2 git head `42ffa65`; app-code smoke slice `62ff184`; `research/amn2/controlled-prod-status-visibility-git-checkout-smoke-2026-06-07.md`; AMN2 source docs `docs/API_VPS_SMOKE_EVIDENCE.ru.md` and `docs/AMN2_VPS_SMOKE_62FF184_RUNBOOK.ru.md` | Either build/promote source-overlay update package and run read-only smoke on `/opt/amn2`, or continue another read-only controller/status slice. No write/config/backup/agent mutation unlock |
| Controlled prod status visibility package | `package-ready-not-vps-smoked` | AMN3 package for `amn2` | `dist/amn2-vps-update-and-smoke-kit-42ffa65.zip`, sha256 `5B43B467E014E87FEC1E49E8D9A8B7A2FBF841541BE88FDC6768097806240E39`; source sha256 `8A5B83D9AB95BE4230AAC221CE0321A37EF37E4E4B6EAB5EDECAE3C98A944829`; evidence `research/amn2/controlled-prod-status-visibility-vps-package-2026-06-07.md` | Operator can run read-only source-overlay update/smoke with `VPS_APPLY_ENABLED=false`. Until pass returns, `/opt/amn2` remains `c8a6363` |
