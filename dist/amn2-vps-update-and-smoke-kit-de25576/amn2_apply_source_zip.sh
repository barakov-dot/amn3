...
AMN2_SOURCE_ZIP="${AMN2_SOURCE_ZIP:-/root/amn2-vps-update-and-smoke-kit-de25576/amn2-codex-vps-test-prep-de25576-source.zip}"
AMN2_EXPECTED_SOURCE_SHA="${AMN2_EXPECTED_SOURCE_SHA:-CFF46C44CFB8F321DEB88CE64A0F5D2154CFC02CD3931CF9955DDC466615B8CC}"
AMN2_EXPECTED_SOURCE_COMMIT="${AMN2_EXPECTED_SOURCE_COMMIT:-de2557639cd3853e6973002be3cab24033d2f722}"
...
next=run read-only post-install checks selected by the active gate
EOF
