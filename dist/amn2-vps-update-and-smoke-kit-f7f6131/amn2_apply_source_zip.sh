...
AMN2_SOURCE_ZIP="${AMN2_SOURCE_ZIP:-/root/amn2-vps-update-and-smoke-kit-f7f6131/amn2-codex-vps-test-prep-f7f6131-source.zip}"
AMN2_EXPECTED_SOURCE_SHA="${AMN2_EXPECTED_SOURCE_SHA:-720B6C9FE3CADDBC65C19BDEC5B0C811D00C94EB0D095D6311DCD90DD77BE4E1}"
AMN2_EXPECTED_SOURCE_COMMIT="${AMN2_EXPECTED_SOURCE_COMMIT:-f7f6131}"
