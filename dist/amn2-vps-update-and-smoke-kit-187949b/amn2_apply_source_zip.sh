...
AMN2_SOURCE_ZIP="${AMN2_SOURCE_ZIP:-/root/amn2-vps-update-and-smoke-kit-187949b/amn2-codex-phase7-current-fixes-187949b-source.zip}"
AMN2_EXPECTED_SOURCE_SHA="${AMN2_EXPECTED_SOURCE_SHA:-649EF03461555B13D8C4AF59709CEEC49F2300C395F69DCA982DF15732409313}"
AMN2_EXPECTED_SOURCE_COMMIT="${AMN2_EXPECTED_SOURCE_COMMIT:-187949b}"
