...
AMN2_SOURCE_ZIP="${AMN2_SOURCE_ZIP:-/root/amn2-canonical-logo-overlay-6abc620/amn2-codex-vps-test-prep-6abc620-source.zip}"
AMN2_EXPECTED_SOURCE_SHA="${AMN2_EXPECTED_SOURCE_SHA:-4BED630024AD58B2E6B7111E172A18CF934262E4BB32DAD7A2787CFFFA4607A4}"
AMN2_EXPECTED_SOURCE_COMMIT="${AMN2_EXPECTED_SOURCE_COMMIT:-6abc620}"
