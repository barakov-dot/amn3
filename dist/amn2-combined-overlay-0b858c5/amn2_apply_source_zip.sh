...
AMN2_SOURCE_ZIP="${AMN2_SOURCE_ZIP:-/root/amn2-combined-overlay-0b858c5/amn2-codex-vps-test-prep-0b858c5-source.zip}"
AMN2_EXPECTED_SOURCE_SHA="${AMN2_EXPECTED_SOURCE_SHA:-E03F13FD6A7BB5CBC5FCEE7179F395EA8C2864EBCEAB01BC351C5904F3CFF975}"
AMN2_EXPECTED_SOURCE_COMMIT="${AMN2_EXPECTED_SOURCE_COMMIT:-0b858c5}"
