...
- Package revision 004 immutability: manifest, collector, runner, and identity hashes match the recorded receipt
- Spain/SSH/stage/install activity during the package revision 005 local correction: none
